...
* [Prompting Claude Opus 4.7](#prompting-claude-opus-4-7)
* [Response length and verbosity](#response-length-and-verbosity)
* [Calibrating effort and thinking depth](#calibrating-effort-and-thinking-depth)
* [Tool use triggering](#tool-use-triggering)
* [User-facing progress updates](#user-facing-progress-updates)
* [More literal instruction following](#more-literal-instruction-following)
* [Tone and writing style](#tone-and-writing-style)
* [Controlling subagent spawning](#controlling-subagent-spawning)
