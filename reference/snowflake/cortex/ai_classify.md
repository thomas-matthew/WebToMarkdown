...
[Reference](/en/reference)[Function and stored procedure reference](/en/sql-reference-functions)AI FunctionsAI\_CLASSIFY
...
### AI\_CLASSIFY: Text[¶](#ai_classify-text)
...
### AI\_CLASSIFY: Images[¶](#ai_classify-images)
