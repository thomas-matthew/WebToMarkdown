...
[Guides](/en/guides)[Snowflake AI & ML](/en/guides-overview-ai-features)[Cortex Agents](/en/user-guide/snowflake-cortex/cortex-agents)REST APIFeedback

# Feedback REST API[¶](#feedback-rest-api)

Use this API to collect feedback about Cortex Agents from end users.

## Collect feedback about a Cortex Agent[¶](#collect-feedback-about-a-cortex-agent)
...
#### Example request body for agent-level feedback[¶](#example-request-body-for-agent-level-feedback)
...
#### Example request body for request-level feedback[¶](#example-request-body-for-request-level-feedback)
...
## View feedback for Cortex Agents[¶](#view-feedback-for-cortex-agents)
...
1. [Collect feedback about a Cortex Agent](#collect-feedback-about-a-cortex-agent)
2. [Request](#request)
3. [Response](#response)
4. [View feedback for Cortex Agents](#view-feedback-for-cortex-agents)
