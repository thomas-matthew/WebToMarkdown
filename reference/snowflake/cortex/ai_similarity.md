...
[Reference](/en/reference)[Function and stored procedure reference](/en/sql-reference-functions)AI FunctionsAI\_SIMILARITY

Categories:
:   [String & binary functions](/sql-reference/functions-string) (AI Functions)

# AI\_SIMILARITY[¶](#ai_similarity)
...
### AI\_SIMILARITY: Text[¶](#ai_similarity-text)
...
### AI\_SIMILARITY: Images[¶](#ai_similarity-images)
