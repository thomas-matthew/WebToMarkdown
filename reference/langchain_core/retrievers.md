...
## BaseRetriever [¶](https://reference.langchain.com/python/langchain_core/retrievers/#langchain_core.retrievers.BaseRetriever "Copy anchor link to this section for reference")
